...
export const CHANGELOG = [
  ...
  },
  {
    ...
    date: '2026-09-10',
    items: [
      '“공정능력(Cpk)” 탭 추가 — 주간 측정값을 모아 치수별 Cp·Cpk 와 상/중/하 등급 표시',
      '설정에 “Cpk 등급 기준” 추가 (상 ≥ 1.33, 중 ≥ 1.00, 최소 측정 횟수 — 변경 가능)',
    ],
  },
  {
    version: '1.7.4',
    date: '2026-09-10',
    items: [
      '앱 설치 정체성(manifest id·scope)을 이 앱 경로로 고정 — 같은 서버의 다른 앱과 설치 충돌 방지',
      '※ 이미 설치했다면 한 번 제거 후 재설치하면 깔끔합니다',
    ],
  },
  {
    version: '1.7.3',
  ...
  },
  {
    ...
    date: '2026-09-07',
    items: [
      '"저장 폴더 보기" 창을 넓히고 파일명이 줄바꿈되도록 — 가로 스크롤 최소화',
    ],
  },
  {
    version: '1.7.1',
